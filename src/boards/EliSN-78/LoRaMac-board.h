...
#define LC2                { 433500000, { ( ( DR_7 << 4 ) | DR_0 ) }, 0 }
...
#define LC2                { 434300000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC3                { 434500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC4                { 434700000, { ( ( DR_7 << 4 ) | DR_0 ) }, 0 }
#define LC5                { 433300000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC6                { 433500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC7                { 433700000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC8                { 433900000, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
#define LC9                { 434200000, { ( ( DR_6 << 4 ) | DR_6 ) }, 0 }
